...
import {
  ...
  Stamp, Headphones, Plane, Home, LifeBuoy, MessageCircle, ArrowRight
} from 'lucide-react';
  ...
  return (
    <main>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, padding: '0 24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '40px', flexWrap: 'wrap' }}>
            {[['12', 'Services'], ['10+', 'Countries'], ['5,000+', 'Students'], ['98%', 'Visa Success']].map(([num, label]) => (
      ...
      <div style={{ background: 'linear-gradient(135deg, #2100B1, #ED4B00)', padding: '80px 24px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '17px', color: 'rgba(255,255,255,0.8)', marginBottom: '32px', maxWidth: '480px', margin: '0 auto 32px' }}>
