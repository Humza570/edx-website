...
export const services = [
  ...
  },
  {
    ...
    detail: {
      tagline: "Plan your finances for a stress-free study abroad.",
      intro: "Funding your education abroad requires careful planning. At EdX Consultants, we help you explore every available financial option — from education loans to blocked accounts — so money is never a barrier to your dreams.",
      whatWeOffer: [
        "Education loan guidance",
        "Blocked account setup assistance (Germany)",
        "Financial aid program identification",
        "Budget planning for living expenses abroad",
        "Scholarship and grant combination strategy",
      ],
      howItWorks: [
        { step: "01", title: "Financial Assessment", desc: "We understand your financial situation and study budget." },
        { step: "02", title: "Options Research", desc: "We identify loans, aid programs, and funding sources." },
        { step: "03", title: "Application Assistance", desc: "We help you apply for the best financial options." },
        { step: "04", title: "Planning Support", desc: "We help you plan expenses for your entire study period." },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    detail: {
      tagline: "Achieve the score your university requires.",
      intro: "A strong IELTS or PTE score is essential for admission to universities in the UK, Australia, Canada, and beyond. Our structured preparation programs are designed to help you reach your target band score efficiently.\n\nOur experienced trainers focus on all four skills — listening, reading, writing, and speaking — with mock tests and personalized feedback.",
      whatWeOffer: [
        "Comprehensive IELTS and PTE training",
        "Module-wise coaching (Reading, Writing, Listening, Speaking)",
      ...
      howItWorks: [
        { step: "01", title: "Level Assessment", desc: "We assess your current English proficiency level." },
        { step: "02", title: "Customized Plan", desc: "We design a study plan based on your target score and timeline." },
        { step: "03", title: "Intensive Training", desc: "Module-wise coaching with practice tests and feedback." },
        { step: "04", title: "Mock Exam", desc: "Full-length mock tests to simulate real exam conditions." },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    detail: {
      ...
      intro: "Our support doesn't end when you board your flight. After you arrive at your destination, our team is available to help you navigate your new environment and get settled as quickly as possible.",
      whatWeOffer: [
        "Local banking setup guidance",
        "Public transport orientation",
        "Part-time work permit information",
        "Networking and community support",
        "Local resource and services guidance",
        "Ongoing counselor availability",
      ],
      howItWorks: [
        { step: "01", title: "Arrival Check-in", desc: "We confirm your safe arrival and immediate next steps." },
        { step: "02", title: "Banking & Admin", desc: "We guide you through setting up a bank account and local admin." },
        { step: "03", title: "Campus Orientation", desc: "We help you understand your university and local area." },
        { step: "04", title: "Ongoing Support", desc: "We remain available for any questions throughout your studies." },
      ],
    },
  },
  {
