...
const reviews = [
  ...
  },
  {
    ...
    time: "3 months ago",
    rating: 5,
    text: "I was confused about which country to choose for my masters. EdX counselors sat with me for hours, understood my profile, and recommended the best options. Got admitted to a top university in Canada. The whole process was smooth and stress-free.",
    color: "#FBBC05",
  },
];
    ...
    <div style={{ display: "flex", gap: "2px" }}>
      {[1, 2, 3, 4, 5].map((s) => (
        <Star
          ...
          color={s <= rating ? "#FBBC05" : "rgba(255,255,255,0.2)"}
          strokeWidth={1.5}
        />
      ))}
    </div>
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(33,0,177,0.12) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(237,75,0,0.08) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
      <div
      ...
      >
        ...
        >
          ...
          >
            What Our Students{" "}
            <span style={{ color: "#EA4335" }}>Say on Google</span>
          </h2>
          ...
          >
            Real reviews from real students — unfiltered, unedited, straight
            from Google.
          </p>
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: "1px",
                  background:
                    "linear-gradient(90deg, transparent, rgba(66,133,244,0.6), transparent)",
                }}
              />
        ...
        <div style={{ textAlign: "center", marginTop: "32px" }}>
          <a
            href="https://search.google.com/local/reviews?placeid=ChIJt0ek-dlBGTkR6UupVMO1niM"
            target="_blank"
