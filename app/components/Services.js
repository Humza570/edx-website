      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "64px" }}>
          <div style={{
            ...
            background: "rgba(33,0,177,0.08)", border: "1px solid rgba(33,0,177,0.15)",
          }}>
          ...
          <h2 style={{ fontSize: "clamp(32px, 5vw, 52px)", fontWeight: 800, color: "#0d0d1a", lineHeight: 1.15, marginBottom: "16px", letterSpacing: "-0.02em" }}>
        ...
        <div style={{ textAlign: "center", marginTop: "64px" }}>
          ...
          <Link
            ...
            style={{
              display: "inline-flex", alignItems: "center", gap: "8px",
              padding: "14px 36px", background: "#ED4B00", color: "white",
              borderRadius: "8px", fontSize: "15px", fontWeight: 700,
              textDecoration: "none", boxShadow: "0 6px 24px rgba(237,75,0,0.35)",
              transition: "all 0.2s",
            }}
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        border: "1px solid rgba(0,0,0,0.06)", boxShadow: "0 2px 16px rgba(0,0,0,0.05)",
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.borderColor = isBlue ? "rgba(33,0,177,0.2)" : "rgba(237,75,0,0.2)";
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <div style={{
        ...
        background: isBlue ? "linear-gradient(90deg, #2100B1, #0ea5e9)" : "linear-gradient(90deg, #ED4B00, #ff9a00)",
      }} />
      ...
      <h3 style={{ fontSize: "18px", fontWeight: 700, color: "#0d0d1a", marginBottom: "12px", lineHeight: 1.3 }}>
        {service.title}
      </h3>

      <p style={{ fontSize: "14px", color: "#666", lineHeight: 1.75, marginBottom: "20px", flex: 1 }}>
        {service.desc}
      </p>
      ...
      <Link
        ...
        style={{
          ...
          fontSize: "13px", fontWeight: 700, color: service.color,
          textDecoration: "none", width: "fit-content", transition: "gap 0.2s",
        }}
