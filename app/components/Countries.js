...
const countries = [
  ...
  },
  {
    ...
    highlight: "Algomau · Avila · Texas State",
    color: "#ED4B00",
  ...
  },
  {
    ...
    highlight: "Canterbury · Waikato · WGTN",
    color: "#ED4B00",
  ...
  },
  {
    ...
    highlight: "MDX · Waish College · University of Greater Manchester",
    color: "#ED4B00",
...
export default function Countries() {
  ...
  useEffect(() => {
    ...
    globeRef.current.pointOfView(
      { lat: selected.lat, lng: selected.lng, altitude: 2.0 },
      900,
    );
  }, [selected, globeReady]);
    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          boxShadow:
            "0 0 60px rgba(33,0,177,0.45), 0 0 120px rgba(237,75,0,0.1)",
          overflow: "hidden",
          background: "#0a0a18",
        }}
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "35px" }}>
          ...
          >
            ...
            >
              ...
              <span style={{ color: "#ED4B00" }}>Starts Here</span>
            </h2>
            <p
              style={{
                fontSize: "17px",
          ...
          {countries.map((country, i) => {
            ...
            return (
              ...
              >
                ...
                {/* flag-icons square flag replacing old image+emoji combo */}
                <div
                  style={{
                    width: "44px",
                    height: "44px",
                ...
                <div style={{ textAlign: "right", flexShrink: 0 }}>
                  <div
                    style={{
                      fontSize: "12px",
                      fontWeight: 700,
                      color: isActive ? country.color : "rgba(255,255,255,0.4)",
                    }}
                  >
                ...
                <ChevronRight
                  size={14}
                  color={isActive ? country.color : "rgba(255,255,255,0.2)"}
                  style={{ flexShrink: 0 }}
                />
              </motion.div>
            );
          ...
          <div style={{ position: "relative", height: "180px" }}>
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(to bottom, rgba(0,0,0,0.1) 0%, rgba(13,13,26,0.98) 100%)",
              }}
            />
            <div style={{ position: "absolute", bottom: "16px", left: "18px" }}>
              {/* flag-icons flag in detail panel */}
              <span
                className={`fi fi-${selected.flag}`}
                style={{
                  display: "block",
