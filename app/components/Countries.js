...
// 6 rows visible, rest scroll
const ROW_HEIGHT = 70;
const LIST_HEIGHT = 6 * ROW_HEIGHT + 40; // 40px = label height
        ...
        <div style={{ textAlign: "center", marginBottom: "35px" }}>
          ...
          >
            ...
            >
              ...
              universities. Pick your destination and we'll take care of the
              rest.
            </p>
            <div
              style={{
...
/* ── Country List — 6 visible, rest scroll ── */
function CountryList({ countries, selected, setSelected, listHeight }) {
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      {/* ✅ Fixed height container — 6 rows show, rest scroll */}
      <div
        style={{
